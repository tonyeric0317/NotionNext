...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '660317', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享投資的個人網站🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://660317.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 660317', // 网站关键词 英文逗号隔开
...
// 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: [
    'data:text/javascript,var s=document.createElement("style");s.innerHTML="#today-card{pointer-events:none !important;cursor:default !important;}";document.head.appendChild(s);'
  ],
  CUSTOM_EXTERNAL_CSS: [''],
